...
public class EnemyManager : MonoBehaviour {
    ...
    private float m_EnemyFireSpeed = 5f;
    ...
    void Spawn()
    {
        ...
        smallControl.m_ShootSpeed = shootspeed + Random.Range(0f, 0.75f);
        smallControl.m_ZoomInPos = Random.Range(2.4f, 5.5f);
        smallControl.m_WantedPos = Random.Range(-3, 3);
        smallControl.m_MoveSpeed = Random.Range(2, 5);
    }
