...
public class HUDUpdate : MonoBehaviour {
	...
	void Update () {
        ...
        if (m_ShipStats.m_Health > 20)
            m_Health.color = new Color32(71, 201, 120, 255);
        else if (m_ShipStats.m_Health <= 20 && m_ShipStats.m_Health > 0)
            m_Health.color = new Color32(230, 180, 100, 255);
        else if (m_ShipStats.m_Health == 0)
